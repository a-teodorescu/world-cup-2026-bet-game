...
function buildEmailReports() {
  ...
  return ranked.map(u => {
    ...
    const rows = items.map(i => {
      ...
      const badgeText = i.type === 'exact' ? 'Scor exact' : i.type === 'winner' ? 'Pronostic corect' : '0p';
